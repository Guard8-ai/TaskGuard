---
id: backend-027
title: Add scan_tasks() iterator helper to reduce WalkDir boilerplate
status: todo
priority: medium
tags:
- backend
dependencies: []
assignee: developer
created: 2025-12-15T12:13:38.243055109Z
estimate: ~
complexity: 3
area: backend
---

# Add scan_tasks() iterator helper to reduce WalkDir boilerplate
